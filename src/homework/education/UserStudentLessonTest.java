...
public class UserStudentLessonTest implements StudentLessonUtil, UserCommands {
    ...
    private static void deleteStudentByEmail() {
        ...
        System.out.println("please input homework.student email");
        String email = scanner.nextLine();
        if (studentStorage.getByEmail(email) != null) {
            studentStorage.deleteStudentBYEmail(email);
            System.out.println();
            System.out.println("homework.student data deleted");
        } else {
            System.out.println();
            System.err.println("There is no homework.student by this email");
        }
    }
    ...
    private static void printStudentsByLesson() {
        StudentLessonUtil.chooseLesson();
        System.out.println("Please enter the name of the homework.student course");

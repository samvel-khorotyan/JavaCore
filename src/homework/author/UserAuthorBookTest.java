...
public class UserAuthorBookTest implements AuthorBookUserCommands {
    ...
    private static void deleteAuthor() {
        ...
        if (author != null) {
            ...
            System.out.println();
            System.out.println("The homework.author has been deleted");
        } else {
            System.out.println();
    ...
    private static void deleteByAuthor() {
        ...
        if (author != null) {
            ...
            System.out.println();
            System.out.println("The homework.author's books have been deleted");
        } else {
            System.out.println();
            System.err.println("Author does not exists");
        }
    ...
    private static void chooseEmail() {
        System.out.println("please choose homework.author's emails separate ,");
        System.out.println("___________________");
        authorStorage.print();
        System.out.println("___________________");
    }
    ...
    private static void changeBookAuthor() {
        ...
        try {
            ...
            System.out.println();
            System.out.println("Thank you book's homework.author is changed");
        } catch (BookNotFoundException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private static void changeAuthor() {
        ...
        Author author = authorStorage.getBYEmail(email);
        if (author != null) {
            System.out.println("please input homework.author's name");
            String name = scanner.nextLine();
            System.out.println("please input homework.author's surname");
            String surname = scanner.nextLine();
            ...
            System.out.println();
            System.out.println("Thank you,homework.author data changed");
